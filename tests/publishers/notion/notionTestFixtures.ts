    ...
    news: [
      {
        ...
        whatHappened: "정부와 관련 기관이 전세보증금 관리 방식 개선을 논의하고 있습니다.",
        previousSituation: "기존에는 집주인이 전세보증금을 직접 보유하는 경우가 많았습니다.",
        whatChanged: "보증금을 별도 계정이나 기관에서 관리하는 방식이 거론되고 있습니다.",
        whyItChanged: "전세사기와 보증금 미반환 위험을 줄이기 위한 목적입니다.",
        householdImpact: "세입자는 보증금 안전성을 더 확인할 수 있지만 전세 공급 변화도 지켜봐야 합니다.",
        newlywedHousingImpact: "신혼부부는 전세 계약 전 보증금 보호 장치를 더 꼼꼼히 확인해야 합니다.",
        expectedNextEffects: [
