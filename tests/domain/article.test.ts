...
describe("AnalyzedNewsSchema", () => {
  function validAnalyzedNews() {
    return {
      ...
      whatHappened: "한국은행이 기준금리를 내렸습니다.",
      previousSituation: "기준금리가 3.25%였습니다.",
      whatChanged: "3.00%로 변경되었습니다.",
      whyItChanged: "경기 둔화 우려 때문입니다.",
      householdImpact: "대출 이자가 줄어들 수 있습니다.",
      newlywedHousingImpact: "주택담보대출 금리가 낮아질 수 있습니다.",
