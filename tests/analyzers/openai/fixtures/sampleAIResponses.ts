  ...
  news: [
    {
      ...
      whatHappened: "한국은행 금융통화위원회가 기준금리를 연 3.25%에서 3.00%로 0.25%포인트 인하했습니다.",
      previousSituation: "기준금리가 연 3.25%로 유지되고 있었으며, 시중은행의 대출금리와 예금금리는 이에 연동되어 움직이고 있었습니다.",
      whatChanged: "기준금리가 0.25%포인트 내려 연 3.00%가 되었습니다. 은행들의 대출금리와 예금금리도 점진적으로 조정될 것으로 보입니다.",
      whyItChanged: "경기 둔화 우려와 물가 안정세를 고려한 한국은행의 판단입니다.",
      householdImpact: "변동금리 대출을 가진 가계는 이자 부담이 줄어들 수 있습니다. 반면 예금이나 적금에 돈을 넣어둔 경우 이자 수입이 줄어들 수 있습니다.",
      newlywedHousingImpact: "주택담보대출을 준비하는 신혼부부에게 유리할 수 있습니다. 대출금리가 낮아지면 같은 금액을 빌려도 매달 갚는 이자가 줄어들기 때문입니다.",
      expectedNextEffects: [
    ...
    },
    {
      ...
      whatHappened: "서울 아파트 매매가격이 3주 연속 상승세를 보이며 거래량도 함께 증가하고 있습니다.",
      previousSituation: "금리 인상 영향으로 부동산 거래가 위축되어 있었습니다.",
      whatChanged: "금리 인하 기대감 등으로 매수세가 살아나며 가격이 상승하고 있습니다.",
      whyItChanged: "금리 인하 기대와 규제 완화 기조가 맞물리며 시장 심리가 개선되었습니다.",
      householdImpact: "주택 보유자에게는 자산 가치 상승이지만, 매수 예정자에게는 부담이 커질 수 있습니다.",
      newlywedHousingImpact: "주택 구입을 계획하는 신혼부부에게는 매입 시기에 대한 고민이 필요한 상황입니다.",
      expectedNextEffects: [
    ...
    },
    {
      ...
      whatHappened: "국토교통부가 신혼부부 특별공급의 소득 기준을 완화하는 방안을 검토 중입니다.",
      previousSituation: "기존 소득 기준으로는 맞벌이 신혼부부 중 상당수가 특별공급 대상에서 제외되었습니다.",
      whatChanged: "소득 기준이 완화되면 더 많은 신혼부부가 특별공급에 지원할 수 있게 됩니다.",
      whyItChanged: "저출산 대응과 주거 안정 정책의 일환으로 검토되고 있습니다.",
      householdImpact: "신혼부부 가정의 주택 마련 기회가 확대될 수 있습니다.",
      newlywedHousingImpact: "맞벌이 신혼부부에게 특히 유리한 변화가 될 수 있습니다. 기존에 소득 기준으로 탈락했다면 재도전이 가능해질 수 있습니다.",
      expectedNextEffects: [
