        ...
        <div className={s.contentGrid}>
          ...
          <article className={s.policy}>
            ...
            <section id="collection">
              ...
              <div className={s.tableWrap}>
                <table>
                  ...
                  <tbody>
                    <tr><td>회원가입·본인확인</td><td>이름, 휴대폰 번호, 닉네임, 생년월일, 성별, 휴대폰 인증 여부</td><td>이용자가 회원가입 및 SMS 인증 과정에서 직접 입력</td></tr>
              ...
              <p className={s.note}>서비스는 주민등록번호 전체를 수집하지 않습니다. 생년월일과 성별 확인을 위해 입력 화면에 표시되는 주민등록번호 앞 7자리 중 생년월일 6자리와 성별 식별값만 처리하며, 뒷자리 전체는 수집하지 않습니다.</p>
            </section>

            <section id="purpose">
              <h2>3. 개인정보의 이용 목적</h2>
              <ul>
                <li>회원가입 의사 확인, 휴대폰 본인확인, 회원 식별 및 로그인 제공</li>
            ...
            <section id="retention">
              ...
              <p>일시적으로 생성되는 SMS 인증번호는 인증 완료 또는 유효기간 만료 후 운영상 필요한 최소 기간만 보관한 뒤 삭제합니다.</p>
            </section>
            ...
            <section id="sharing">
              ...
              <p>SMS 인증이나 서비스 인프라 운영을 위해 외부 업체가 정보를 처리하는 경우는 아래의 처리 위탁에 해당하며, 그 목적 외로 이용하지 않도록 관리·감독합니다.</p>
            </section>
            ...
            <section id="outsourcing">
              ...
              <div className={s.tableWrap}>
                <table>
                  ...
                  <tbody>
                    <tr><td>SOLAPI</td><td>휴대폰 인증번호 발송(휴대폰 번호)</td><td>위탁 목적 달성 또는 수탁자의 법정 보관기간까지</td></tr>
                    <tr><td>OpenAI API</td><td>경제 뉴스의 분류·요약·분석(뉴스 기사 데이터)</td><td>서비스 제공에 필요한 기간 또는 제공자의 정책에 따른 기간</td></tr>
                  </tbody>
                </table>
              </div>
              <p>OpenAI API에는 뉴스 기사 데이터만 전송하며, 이름·휴대폰 번호·생년월일·성별·닉네임 등 회원 개인정보를 의도적으로 전송하지 않습니다. 해외 사업자가 개인정보를 처리하게 되는 기능을 추가하는 경우에는 이전 국가, 이전 시기와 방법, 수령자, 이용 목적과 보유 기간 및 이전 거부 방법을 관계 법령에 따라 별도로 고지하고 필요한 동의를 받겠습니다.</p>
            ...
            <section id="security">
              ...
              <ul>
                ...
                <li>인증번호 등 중요한 정보는 저장·전송 과정에서 적절한 암호화 또는 이에 준하는 보호 조치를 적용합니다.</li>
