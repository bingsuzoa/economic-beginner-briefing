...
@Component
public class NewsisSourceAdapter extends AbstractRssSourceAdapter {

    public NewsisSourceAdapter(RssParser rssParser, ArticleNormalizer normalizer, CategoryClassifier categoryClassifier) {
        super(rssParser, normalizer, categoryClassifier);
    }

    @Override
    public String getSourceName() { return "뉴시스"; }

    @Override
    public String getFeedUrl() { return "https://www.newsis.com/RSS/economy.xml"; }
