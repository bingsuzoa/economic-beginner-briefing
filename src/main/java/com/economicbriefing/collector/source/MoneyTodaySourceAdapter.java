...
public class MoneyTodaySourceAdapter extends AbstractRssSourceAdapter {

    public MoneyTodaySourceAdapter(RssParser rssParser, ArticleNormalizer normalizer, CategoryClassifier categoryClassifier) {
        super(rssParser, normalizer, categoryClassifier);
    }

    @Override
    public String getSourceName() { return "머니투데이"; }

    @Override
    public String getFeedUrl() { return "https://rss.mt.co.kr/mt_news.xml"; }
