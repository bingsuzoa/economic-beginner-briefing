...
@Component
public class SBSBizSourceAdapter extends AbstractRssSourceAdapter {

    public SBSBizSourceAdapter(RssParser rssParser, ArticleNormalizer normalizer, CategoryClassifier categoryClassifier) {
        super(rssParser, normalizer, categoryClassifier);
    }

    @Override
    public String getSourceName() { return "SBS Biz"; }

    @Override
    public String getFeedUrl() { return "https://news.sbs.co.kr/news/SectionRssFeed.do?sectionId=02&plink=RSSREADER"; }
