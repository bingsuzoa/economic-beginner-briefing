...
public class ArticleAnalyzerResultEntity {
    ...
    @Column(name = "analyzer_prompt_version", length = 32)
    private String analyzerPromptVersion;
    ...
    public String getAnalyzerPromptVersion() { return analyzerPromptVersion; }
    public void setAnalyzerPromptVersion(String analyzerPromptVersion) {
        this.analyzerPromptVersion = analyzerPromptVersion;
    }
