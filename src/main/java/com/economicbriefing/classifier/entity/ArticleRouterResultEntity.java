...
@Entity
@Table(name = "article_router_results")
public class ArticleRouterResultEntity {
    ...
    @Column(name = "router_json", nullable = false, columnDefinition = "TEXT")
    private String routerJson;

    @Column(name = "model_name", length = 128)
    private String modelName;

    @Column(name = "router_prompt_version", nullable = false, length = 64)
    ...
    public String getRouterJson() { return routerJson; }
    public void setRouterJson(String routerJson) { this.routerJson = routerJson; }
