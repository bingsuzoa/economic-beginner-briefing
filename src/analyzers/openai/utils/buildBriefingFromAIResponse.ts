...
function mapAINewsToAnalyzedNews(
  ...
  return {
    ...
    whatHappened: aiNews.whatHappened,
    previousSituation: aiNews.previousSituation,
    whatChanged: aiNews.whatChanged,
    whyItChanged: aiNews.whyItChanged,
    householdImpact: aiNews.householdImpact,
    newlywedHousingImpact: aiNews.newlywedHousingImpact,
